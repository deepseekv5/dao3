...
// 声明实质变了（官方素材从"不分发"改成"随包分发但需应用内确认"）就要升版本，
// 让已经点过"进入"的人重新看到与现状一致的那一版，而不是继续拿旧同意用新素材。
const ACK_VER = "2";
...
const TEXT = {
  ...
  blocks: [
    ...
    ["关于官方素材与地图数据", [
      ...
      "官方<b>地图数据、20 个赛道模型与 40 个音效</b>随本包一起分发。这是<b>仓库所有者做的分发决定</b>，不等于这些素材获得了 Apache-2.0 授权——它们的著作权归属没有变化，也不构成任何权利人的许可。",
      "因此本仓库<b>默认不放行</b>这些内容：地图不会自动装进世界库，模型与音效的请求在服务端一律 403，直到你在应用内明确确认自己<b>有权获取并在本地使用</b>它们。",
      "除本包之外，<b>不得</b>再把这些素材转发布、商业分发或冒充官方产品。",
      "本项目与 box3lab / 神奇代码岛官方<b>无任何隶属、授权或背书关系</b>。",
    ]],
  ],
  note: "继续使用即表示你已阅读并同意：本工具与随包的官方素材仅供本地学习与兼容性研究，是否有权获取和使用由你本人确认并承担相应责任；你产生的地图与内容的权利责任由使用者自行承担。",
  agree: "我已阅读并理解上述声明",
  ok: "进入",
  leave: "离开",
};
