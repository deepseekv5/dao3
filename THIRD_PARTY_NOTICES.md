...
一句话结论：**本仓库不含任何游戏素材本体。** 方块图集与两张 ID/规格表来自
Apache-2.0 的上游仓库；音频、赛道模型、官方地图数据一律不随仓库分发，
需要的人用自有权限自行取回（见下）。
